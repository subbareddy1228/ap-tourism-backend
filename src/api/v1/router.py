...
from src.api.v1.endpoints import auth, bookings, coupons, destination, guide, packages, payments, reviews, users, vehicles, wallet, partner, temple, darshan, hotels
