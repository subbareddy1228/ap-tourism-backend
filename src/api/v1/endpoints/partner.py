...
def register_partner(
    ...
    """
    Register as a partner: type (HOTEL/VEHICLE/GUIDE), business_name, GSTIN, PAN.
    Sets status = APPLIED.
    """
    start = time.time()
    result = partner_service.register_partner(db, user.id, data)
    logger.info({
...
def get_my_profile(
    ...
    result = partner_service.get_partner_profile(db, user.id)
...
def update_my_profile(
    ...
    result = partner_service.update_partner_profile(db, user.id, data)
...
def get_dashboard(
    ...
    result = partner_service.get_dashboard_stats(db, user.id)
...
def list_bookings(
    ...
    result = partner_service.get_partner_bookings(db, user.id, status, page, limit)
    return success(result)
...
def get_booking_detail(
    ...
    result = partner_service.get_partner_booking_detail(db, user.id, booking_id)
    return success(result)
...
def accept_booking(
    ...
    result = partner_service.accept_booking(db, user.id, booking_id)
...
def reject_booking(
    ...
    result = partner_service.reject_booking(db, user.id, booking_id, data)
...
def get_earnings(
    ...
    result = partner_service.get_earnings_summary(db, user.id)
    return success(result)
...
def list_payouts(
    ...
    result = partner_service.get_payouts(db, user.id, page, limit)
    return success(result)
...
def get_payout(
    ...
    result = partner_service.get_payout_detail(db, user.id, payout_id)
    return success(result)
...
def update_bank_details(
    ...
    result = partner_service.update_bank_details(db, user.id, data)
...
def list_documents(
    ...
    result = partner_service.get_documents(db, user.id)
    return success(result)
...
def upload_document(
    ...
    result = partner_service.upload_document(db, user.id, document_type, file_url)
...
def delete_document(
    ...
    result = partner_service.delete_document(db, user.id, doc_id)
    return success(result)
...
def update_availability(
    ...
    result = partner_service.update_availability(db, user.id, data)
...
def update_settings(
    ...
    result = partner_service.update_settings(db, user.id, data)
...
def get_analytics(
    ...
    result = partner_service.get_analytics(db, user.id)
    return success(result)
...
def get_notifications(
    ...
    result = partner_service.get_partner_notifications(db, user.id, page, limit)
    return success(result)
...
def get_reviews(
    ...
    result = partner_service.get_partner_reviews(db, user.id, page, limit)
    return success(result)
...
def reply_to_review(
    ...
    result = partner_service.reply_to_review(db, user.id, review_id, data)
