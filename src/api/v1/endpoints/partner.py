...
async def register(
    ...
    """
    Register as a partner. Sets verification_status = APPLIED.
...
async def get_earnings_report(
    ...
    """Download earnings report as CSV with optional date filters."""
...
async def upload_document(
    doc_type: str = Query(
        ...,
        description="Document type: GSTIN | PAN | BANK_PROOF | PROPERTY_DOC | OTHER",
    ),
    ...
    If a document of the same type already exists and is not yet verified,
    it will be replaced. Verified documents cannot be replaced without admin action.
    """
...
async def delete_document(
    ...
    """Delete a document. Only allowed if not yet verified by admin."""
